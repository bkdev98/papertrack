    ...
    <ToastContext value={{ show }}>
      ...
      >
        {toasts.map((t) => (
          <div
            key={t.id}
            className="animate-pt-up pointer-events-auto flex items-center gap-3 bg-ink px-4 py-2.5 font-mono text-[11px] tracking-[0.6px] text-paper"
            style={{
          ...
          >
            ...
            {t.action && (
              <button
                ...
                className="shrink-0 cursor-pointer font-mono text-[11px] uppercase tracking-[0.5px] text-[#e3b354] underline decoration-[1.5px] underline-offset-2 transition-colors hover:text-paper"
              >
                {t.action.label}
              </button>
            )}
