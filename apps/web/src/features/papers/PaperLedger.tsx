...
export function PaperLedger({ papers }: { papers: Paper[] }) {
  ...
  return (
    <div className="animate-pt-fade">
      {/* Header row */}
      <div
        className="grid items-end gap-x-3 border-b-[1.5px] border-ink pb-1.5 pl-2"
      ...
      >
        {HEADERS.map((h) => (
          <button
            ...
            className={cn(
              'font-mono text-[9px] uppercase tracking-[1.4px] text-muted',
      ...
      {shown.map((p, i) => {
        ...
        return (
          <div
            ...
            className="margin-rule grid animate-pt-fade cursor-pointer items-center gap-x-3 border-b border-rule-2 py-2.5 pl-2 transition-all duration-150 hover:translate-x-1 hover:bg-[rgba(163,56,43,0.05)]"
            style={{
          ...
          >
            ...
            <div className="min-w-0">
              <div className="truncate font-serif text-[15.5px] font-medium leading-[1.35] text-ink">
                {p.title}
              </div>
              <div className="truncate font-serif text-[12.5px] italic text-muted">
                {p.venue}
                {p.note && (
            ...
            <div className="truncate font-serif text-[12px] italic text-muted">
            ...
            <div className="flex flex-col gap-1">
              <div className="flex items-center gap-1.5">
                ...
                <AdvanceArrow status={p.status} onAdvance={() => advance.mutate(p.id)} size={14} />
              </div>
